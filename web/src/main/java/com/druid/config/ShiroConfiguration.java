...
import com.druid.config.filter.ShiroAnonymousFilter;
import com.druid.config.filter.ShiroAuthorizationFilter;
...
public class ShiroConfiguration {
	...
	public SessionManager sessionManager() {
		...
		SimpleCookie cookie = new SimpleCookie("ds" + "_SESSIONID");
